...
namespace TurboLinks.Net
{
    public static class TurboLinksExtensions
    {
        ...
        public static IActionResult TurboLinkRedirectToPage(this PageModel model, string pageName, string pageHandler = null, object values = null, string protocol = null)
        {
            var url = model.Url.Page(pageName, pageHandler, values, protocol);
            return new TurbolinkRedirectResult(url);
        }
        ...
        public static IActionResult TurboLinkRedirectToPage(this Controller model, string pageName, string pageHandler = null, object values = null, string protocol = null)
        {
            var url = model.Url.Page(pageName, pageHandler, values, protocol);
            return new TurbolinkRedirectResult(url);
        }
